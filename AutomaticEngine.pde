  ...
  void playAction(int eventType, int actionNumber, int actionValue) {
    ...
    if (eventType == NOTE_ON) {
      switch (actionNumber) {
        ...
        case PITCH_DMX_ANIMATION_MOVING_HEAD_SET_ZOOM_STYLE:    loadDMXAnimation_movingHead_setZoomStyle(actionValue); break;
        ...
        case PITCH_DISPLAY_EFFECT_3:                            activateAdditionalEffect3(actionValue);break;
        case PITCH_DISPLAY_EFFECT_4:                            activateAdditionalEffect4(actionValue);break;
      ...
      switch (actionNumber) {        
        ...
        case PITCH_DMX_ANIMATION_MOVING_HEAD_SET_ZOOM_STYLE:    break;
        ...
        case PITCH_DISPLAY_EFFECT_3:                            deactivateAdditionalEffect3(actionValue);break;
        case PITCH_DISPLAY_EFFECT_4:                            deactivateAdditionalEffect4(actionValue);break;
        default: break;
      }
    }
  }
